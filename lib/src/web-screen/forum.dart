...
class CommunityForumWebScreen extends StatefulWidget {
  const CommunityForumWebScreen({super.key});

  @override
  State<CommunityForumWebScreen> createState() => _CommunityForumScreenState();
}

class _CommunityForumScreenState extends State<CommunityForumWebScreen> {
  final router = "/forums";
